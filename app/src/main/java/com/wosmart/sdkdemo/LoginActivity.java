...
//                }
            ...
            public void onClassAddress(String address) {
                ...
                showToast("经典蓝牙地址:" + address);

                classicAddress = address;

//                BluetoothDevice device=new BluetoothDevice(classicAddress);
//                connect();
//                startScan();
            }
            ...
            public void onClassicStatus(int status) {
                ...
                showToast("经典蓝牙状态:" + status);
            }
        };

        connectListener = new LoginActivity.ConnectListener() {
            @Override
                    ...
                    if (null != mac) {
                        if (classicAddress.equalsIgnoreCase(mac)) {
                            ...
                            if (state == BluetoothDevice.BOND_NONE) {
                                ...
                                LoginActivity.this.remoteDevice = device;
                                connectProfile();
                            }
                        }
                    }
